...
public class FilterConverter {
    ...
    public static String toJson(Filter filter) throws JSONException, JsonProcessingException {
    ...
    private static void entryToMap(List<Map<String,Object>> list, Filter entry ){
    ...
    public static void main(String[] args) throws JSONException, JsonProcessingException {
        ...
        final Filter bean =
                Filter.builder().whereLessThan("da", 12.2)
                        .thenEqual("name","周伟")
                            .thenOr(Filter.orBuilder().whereBetweenAnd("id", 1,2)).thenEqual("a","1d")
                                .thenOr(Filter.orBuilder().whereBetweenAnd("id", 1,2)).breakOr()
                            .breakOr()
